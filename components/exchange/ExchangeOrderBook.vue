<template>
  <v-flex ref="container" class="exchange-block-container FlexHalf-1" column>
    <v-flex class="exchange-block-title mt-4" d-flex justify-space-between>
    </v-flex>
    <!-- 标题开始 -->
    ...
    <v-flex
      ref="sellRows"
      class="info-row-container sell-rows  justify-end"
    ...
    <v-flex d-flex column align-center class="current-order">
      ...
      <!-- <v-tooltip
        :nudge-top="8"
        :content-class="'status-tips'"
        class="netstatus pt-0"
        right
        top
      >
        ...
        <div>
          <div class="status-tips-item">
            ...
            <span class="s-status">{{
              netstatus.market
                ? $t('exchange.netstatus-ok')
                : $t('exchange.netstatus-delay')
            }}</span>
          </div>
          <div class="status-tips-item">
    ...
    <v-flex
      ref="buyRows"
      class="info-row-container buy-rows  d-flex flex-column justify-end"
