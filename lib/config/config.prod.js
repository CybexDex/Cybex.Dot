export default {
  ...
  cybexDotServer: 'wss://dotws.cybex.io/',
  cybexDotExplorerApiServer: 'https://dotapi.cybex.io/api/v1/',
  cybexDotMarketApiServer: 'https://scan-sub.cybex.io/api/v1/harvester/',
  cybexDotCustomTypes: {
    Token: {
      hash: 'H256',
      symbol: 'Vec<u8>',
